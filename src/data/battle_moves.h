...

{
    ...
    [MOVE_CRUNCH] =
    {
        .effect = EFFECT_SPECIAL_DEFENSE_DOWN_HIT, // candidate
        .power = 80,
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 15,
